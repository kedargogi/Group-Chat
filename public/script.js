  ...
  axios
    ...
    .then((response) => {
      ...
      for (let i = 0; i < response.data.data.length; i++) {
        ...
        content += `<div class="grpdetail"><span class="grpele">${grpname}</span><button type="submit" onclick="jumpintogroup(${grpid})" class="grpele btn" id="jumpbtn">Chat</button><div><label>Enter your message:   
